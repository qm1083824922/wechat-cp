...
public class URLConstant {
    ...
    public final static String PURCHASE_DOMAIN = "http://127.0.0.1:8080/scfs/wechat/purchase/";
    ...
    public final static String WAITING_ORDER_LIST = "/wechat/authorize?returnUrl=http://wx.asters.cn/pay/portal/waitingPayOrderList";
    ...
    //--------------------------采购订单相关----------------------------
    //查询采购订单详情
    public final static String PURCHASE_ORDER = PURCHASE_DOMAIN + "purchaseOrder/";
    //商务审核
    public final static String PURCHASE_COMMERCIAL_AUDIT = PURCHASE_DOMAIN + "commercial/audit/";
    //财务专员审核
    public final static String PURCHASE_FINANCE_AUDIT = PURCHASE_DOMAIN + "finance/audit/";
    //财务主管审核
    public final static String PURCHASE_FINANCE_MANAGER_AUDIT = PURCHASE_DOMAIN + "financeManager/audit/";
    //风控专员审核
    public final static String PURCHASE_RISK_AUDIT = PURCHASE_DOMAIN + "risk/audit/";
    //风控主管审核
    public final static String PURCHASE_RISK_MANAGER_AUDIT = PURCHASE_DOMAIN + "riskManager/audit/";
    //总经理审核
    public final static String PURCHASE_BOSS_AUDIT = PURCHASE_DOMAIN + "boss/audit/";
    //拒绝审核
    public final static String PURCHASE_UNPASS_AUDIT = PURCHASE_DOMAIN + "unpass/audit/";

    public final static String PURCHASE_AUDIT_RECORDS = PURCHASE_DOMAIN + "audit/records/";
