select
    ...
    temp4.busiUnitId,
    temp4.projectName,
    sum(temp4.end_num) end_num,
    sum(temp4.end_amount) end_amount
from
    (SELECT
         temp3.projectId,
         temp3.busiUnitId,
             ...
             FROM
                 (
                     ...
                     WHERE
                       ...
                       AND tbis.receive_date < '2019-12-20 00:00:00'
                       AND tbis.STATUS = 2
--                        AND tbp.id = 10
--                        AND tbp.business_unit_id = 112
             ...
             FROM
                 (
                     ...
                     WHERE
                       ...
                       AND bup.state = 1
                       AND ( tbs.subject_type & 1 = 1 )
                       AND tbos.send_date < '2019-12-20 00:00:00'
                       AND tbos.STATUS = 5
                     -- AND tbp.id = 10
                     -- AND tbp.business_unit_id = 112
                     -- and tbg.number = 'P100001051'
    ...
    ) temp4 where 1 = 1 and end_num>0 and end_amount>0 and (projectId!=3 or busiUnitId!=7)  GROUP BY projectId,busiUnitId
